  ...
  theme: {
    extend: {
      backgroundImage: theme => ({
         ...
         'walking-meditation': "url('/src/images/latest-articles/How-to-create-a-mindful-home-office.png')",
         'always-tired': "url('/src/images/latest-articles/Why-am-I-always-tired.png')",
         'home-office': "url('/src/images/latest-articles/Walking meditation.png')",
         'mindful-eating': "url('/src/images/latest-articles/What-is-mindful-eating.png')",
         'power-napping': "url('/src/images/latest-articles/Power-napping-101.png')",
